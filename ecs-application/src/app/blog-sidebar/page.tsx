import RelatedPost from "@/components/Our-teams/RelatedPost";
import SharePost from "@/components/Our-teams/SharePost";
import TagButton from "@/components/Our-teams/TagButton";
import NewsLatterBox from "@/components/Support/NewsLatterBox";
...
export const metadata: Metadata = {
  ...
  description: "This is Blog Details Page for EruditionSolution Nextjs Template",
  // other metadata
};
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl leading-tight font-bold text-primary sm:text-4xl sm:leading-tight dark:text-white">
                ...
                <div>
                  ...
                  <h3 className="font-xl mb-10 leading-tight font-bold text-primary sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight dark:text-white">
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="EruditionSolution" />
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                <h3 className="border-body-color/10 border-b px-8 py-4 text-lg font-semibold text-primary dark:border-white/10 dark:text-white">
                  Related Posts
                </h3>
                <ul className="p-8">
