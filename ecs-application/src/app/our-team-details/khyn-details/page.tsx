...
export const metadata: Metadata = {
  title: "Khyn Harold Antoque | EruditionSolution",
  description: "Learn more about Khyn Harold Antoque, Full Stack Developer at Erudition Solutions",
};

const KhynDetailsPage = () => {
  return (
    <>
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-4xl shadow-2xl p-10 transition-all duration-500">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative w-40 h-40 rounded-full overflow-hidden shadow-lg border-4 border-primary">
                  <Image
                    src="/images/members/khyn.jpg"
                    alt="Khyn Harold Antoque"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h1 className="text-4xl font-extrabold text-primary dark:text-primary mb-2">Khyn Harold Antoque</h1>
                  <h2 className="text-xl font-semibold text-primary dark:text-gray-200 mb-4">Full Stack Developer</h2>
                  <p className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                    Khyn Harold Antoque is a skilled Full Stack Developer with expertise in modern web technologies and a passion for creating innovative educational solutions.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4 justify-center md:justify-start">
                    ...
                    <TagButton text="API Development" />
                  </div>
              ...
              <div className="space-y-6 text-body-color dark:text-body-color-dark leading-relaxed">
                <h3 className="text-2xl font-bold text-primary dark:text-white mb-2">About Khyn Harold Antoque</h3>
                <p>
                  As a Full Stack Developer at Erudition Solutions, Khyn specializes in developing comprehensive web applications that enhance the learning experience for students and educators alike.
                </p>
                <p>
                  Khyn&apos;s expertise spans both frontend and backend development, ensuring seamless integration and optimal performance across all our educational platforms.
                </p>
              </div>
...
export default KhynDetailsPage; 
